...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 50px auto;
            padding: 20px;
            background: #fff; /* White background for the quiz container */
            border: 1px solid #ddd;
            border-radius: 10px;
            color: black; /* Set text color to black inside the container */
        }
...
<h2>___QUIZ_WEBSITE___</h2>
    <p>Hello, <?php echo htmlspecialchars($_SESSION['username']); ?></p>
    <div class="container">
        <h2>Simple PHP Quiz</h2>
        <form method="POST" action="result.php">
            <?php foreach ($quiz_questions as $q_no => $question): ?>
                <div class="question">
